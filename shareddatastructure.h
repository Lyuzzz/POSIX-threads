...
#include <algorithm>
#ifndef A_02_SHAREDDATASTRUCTURE_H
#define A_02_SHAREDDATASTRUCTURE_H
/**
...
#define DEFAULT_NUMOF_DICT 0;
#define DEFAULT_NUMOF_TEXT 0;
...
typedef struct {
    ...
    /**
     * for the detect length of each line input
     */
    long numCharDict = DEFAULT_NUMOF_DICT;
    long numCharText = DEFAULT_NUMOF_TEXT;


    /**
       * peDict and peText are to get totalNumOfCharsInFile
       * of each loop
       *
       * peDict1 and peText1 are to get the last position
       * in order to track the progress and print out
       * progress bar
       */
    double peDict = DEFAULT_NUMOF_DICT;
    int peDict1 = DEFAULT_NUMOF_DICT;
    double peText = DEFAULT_NUMOF_TEXT;
    int peText1 = DEFAULT_NUMOF_TEXT;
    int pe = DEFAULT_NUMOF_TEXT;
    /**
...
#endif //A_02_SHAREDDATASTRUCTURE_H
